	...
	createClass(GMap, [{
		...
		value: function createMarker(markerData, latlng) {
			...
			this.google.maps.event.addListener(marker, 'click', function () {
				_this3.infoWindow.setContent(html);
		...
		value: function displayMarkers() {
			...
			for (var i = 0; i < this.markerData.length; i += 1) {
				var $this = this.markerData[i];
				var latlng = new this.google.maps.LatLng($this.map.Latitude, $this.map.Longitude);
